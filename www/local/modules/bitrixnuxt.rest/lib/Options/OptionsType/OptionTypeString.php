<?
namespace Bitrixnuxt\Rest\Options\OptionsType;

use Bitrixnuxt\Rest\Options\{AbstractOptionType, OptionTypeInterface};
use Exception;

final Class OptionTypeString extends AbstractOptionType implements OptionTypeInterface
{
    protected $Code;
    protected $Value;
